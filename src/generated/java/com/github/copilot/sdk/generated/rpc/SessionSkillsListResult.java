...
public class SessionSkillsListResult {
    ...
    /** Available skills */
    @JsonProperty("skills")
    private List<SessionSkillsListResultSkillsItem> skills;

    public List<SessionSkillsListResultSkillsItem> getSkills() { return skills; }
    public void setSkills(List<SessionSkillsListResultSkillsItem> skills) { this.skills = skills; }


    @JsonIgnoreProperties(ignoreUnknown = true)
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public static class SessionSkillsListResultSkillsItem {
